...
icons.print = `<svg viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
...
icons.background = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons['spell-check'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons.clean = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons.underline = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons.link = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
...
icons.bold = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons.comment = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
...
icons.italic = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
<path xmlns="http://www.w3.org/2000/svg" d="M5 16v-2h2.375l3.187-8H8V4h7v2h-2.271l-3.208 8H12v2Z" fill="#444746"/>
</svg>`;
icons.checklist = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons['paint-format'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
icons.image = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22 22">
...
icons['line-and-paragraph-spacing'] = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18">
...
const Editor = () => {
    ...
    if (italicButton) {
        italicButton.addEventListener('click', function() {
            console.log('clicked!')
            italicButton.classList.toggle('clicked');
        });
    }
    var italicButton1 = document.querySelector('.ql-bold');
    if (italicButton1) {
        italicButton1.addEventListener('click', function() {
            console.log('clicked 1!')
            italicButton1.classList.toggle('clicked');
        });
    }
    var italicButton2 = document.querySelector('.ql-underline');
    if (italicButton2) {
        italicButton2.addEventListener('click', function() {
            console.log('clicked! 2')
            italicButton2.classList.toggle('clicked');
        });
    }
    var italicButton3 = document.querySelector('.ql-line');
    if (italicButton3) {
        italicButton3.addEventListener('click', function() {
            console.log('clicked 3!')
            italicButton3.classList.toggle('clicked');
        });
    }
    var italicButton4 = document.querySelector('.ql-line-and-paragraph-spacing');
    if (italicButton4) {
        italicButton4.addEventListener('click', function() {
            console.log('clicked 4!')
            italicButton4.classList.toggle('clicked');
        });
    }
    ...
    useEffect(() => {
        const quill = new Quill('#container', {
            theme: 'snow',
            modules:{toolbar:toolbarOptions,history: {
                delay: 2000,
                maxStack: 500,
                userOnly: true
            },
    ...
    useEffect(() => {
        ...
        const handlePrint = async () => {
            ...
            try {
                ...
                visibleDiv.innerHTML = quillContent;
                const pdfData = await html2pdf().from(visibleDiv).set(pdfOptions).outputPdf();
        ...
        const printButton = document.querySelector('.ql-print');
        undoButton && undoButton.addEventListener('click', handleUndo);
        redoButton && redoButton.addEventListener('click', handleRedo);
        printButton && printButton.addEventListener('click', handlePrint);
    
        return () => {
            undoButton && undoButton.removeEventListener('click', handleUndo);
            redoButton && redoButton.removeEventListener('click', handleRedo);
            printButton && printButton.removeEventListener('click', handlePrint);
        };
    }, [quill, socket]);
